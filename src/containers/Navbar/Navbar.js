            ...
            <nav className="navbar navbar-expand-lg">
                <div className="container pt-lg-3 ">
                    <a className="navbar-brand px-lg-5" href="/">
                        <img src={t2clogo} className='img-fluid' alt='Kennovatelogo' href='../Home' width='100%' />
                    </a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav  mb-2 mb-lg-0 ms-auto gap-lg-5">
                            <li className="nav-item">
                                <a className="nav-link text-dark" href='/' aria-current="page" id='navitem'>{line===1?<p className='navmenucolor'><HiOutlineMinus/> Home</p>:<p>Home</p>}</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link text-dark" href='../Aboutus' aria-current="page" id='navitem'>{line===3?<p className='navmenucolor'><HiOutlineMinus/> About Us</p>:<p>About Us</p>}</a>
                            </li>
                            <li className="nav-item">
